...
* <a name="indentation-espaces"></a>
  Utilisez 2 **espaces** par niveau d'indentation.
  Pas de tabulations.
  <sup>[[lien](#indentation-espaces)]</sup>

  ```elixir
  # déconseillé - 4 espaces
...
* <a name="operateur-pipe"></a>
  Utilisez l'opérateur pipe (`|>`) pour enchaîner les fonctions d'une manière
  plus lisible.
...
* <a name="variable-seule"></a>
  ...
  ```elixir
  # NE FAITES PAS ÇA!
  # Ceci est en fait interprété comme String.strip("nope" |> String.downcase()).
...
* <a name="espaces-tabs-en-fin-de-ligne"></a>
  Ne laissez pas d'espaces et/ou tabulations inutiles en fin de ligne.
  <sup>[[lien](#espaces-tabs-en-fin-de-ligne)]</sup>

* <a name="fin-de-ligne-en-fin-de-fichier"></a>
  Chaque fichier doit se terminer par une fin de ligne.
  <sup>[[lien](#fin-de-ligne-en-fin-de-fichier)]</sup>
...
* <a name="module-espacement-des-blocs"></a>
  Laissez une ligne vide après chaque bloc de code au niveau du module.
  <sup>[[lien](#module-espacement-des-blocs)]</sup>
